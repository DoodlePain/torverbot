...
module.exports = {
  list: function(msg){
    ...
    request({
      ...
      let parseMode = 'html';
      bot.bot.sendMessage(msg.from.id,"<b>Lunedi</b>' :"+orario[0], {parseMode}).then(()=>{
        return bot.bot.sendMessage(msg.from.id,"<b>Martedi'</b> :"+orario[1], {parseMode}).then(()=>{
          return bot.bot.sendMessage(msg.from.id,"<b>Mercoledi'</b> :"+orario[2], {parseMode}).then(()=>{
            return bot.bot.sendMessage(msg.from.id,"<b>Giovedi'</b> :"+orario[3], {parseMode}).then(()=>{
              return bot.bot.sendMessage(msg.from.id,"<b>Venerdi'</b> :"+orario[4], {parseMode})
            })
          })
        })
      })
